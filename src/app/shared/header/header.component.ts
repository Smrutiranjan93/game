...
export class HeaderComponent  {
  ...
  //   const minimizeButton = this.el.nativeElement.querySelector(
  //     '[data-bs-toggle="minimize"]'
  //   );
  //   const offcanvasButton = this.el.nativeElement.querySelector(
  //     '[data-bs-toggle="offcanvas"]'
  //   );
  //   const body = this.el.nativeElement.ownerDocument.body;
  //   const sidebar =
  //     this.el.nativeElement.ownerDocument.getElementById('sidebar');
